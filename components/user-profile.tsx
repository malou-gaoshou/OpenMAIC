  ...
  return (
    <Card className="p-5 !gap-0 shadow-xl border-muted/40 backdrop-blur-xl bg-white/80 dark:bg-slate-900/80">
      ...
      <div className="flex items-center gap-3.5">
        ...
        >
          <div className="size-11 rounded-full bg-gray-50 dark:bg-gray-800 overflow-hidden ring-2 ring-blue-300/50 dark:ring-blue-600/40 group-hover/avatar:ring-blue-400 dark:group-hover/avatar:ring-blue-500 transition-all">
          ...
          {editingName ? (
            <div className="flex items-center gap-1.5">
              <input
                ...
                className="flex-1 min-w-0 h-7 bg-transparent border-b-2 border-blue-400 dark:border-blue-500 text-sm font-semibold text-foreground outline-none placeholder:text-muted-foreground/40"
              />
              <button
                onClick={commitName}
                className="shrink-0 size-6 rounded-md flex items-center justify-center text-blue-500 hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors"
              >
              ...
              {AVATAR_OPTIONS.map((url) => (
                <button
                  ...
                  className={cn(
                    ...
                    avatar === url
                      ? 'ring-2 ring-blue-400 dark:ring-blue-500 ring-offset-1 ring-offset-white dark:ring-offset-slate-900'
              ...
              <label
                ...
                className={cn(
                  ...
                  isCustomAvatar(avatar)
                    ? 'ring-2 ring-blue-400 dark:ring-blue-500 ring-offset-1 ring-offset-white dark:ring-offset-slate-900 border-blue-300 dark:border-blue-600 bg-blue-50 dark:bg-blue-900/30'
