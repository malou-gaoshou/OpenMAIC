                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isSendCooldown
                        ...
                        : 'bg-blue-600 hover:bg-blue-700 shadow-[0_4px_16px_rgba(147,51,234,0.3)]',
                    )}
                  >
                    {isSendCooldown ? (
              ...
              >
                <div className="flex items-center gap-4 bg-white/70 dark:bg-black/60 backdrop-blur-xl rounded-full px-5 py-3 shadow-[0_8px_32px_rgba(0,0,0,0.08)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)] border border-gray-200/60 dark:border-white/10">
                  ...
                  <div className="flex items-center gap-0.5 h-8">
                    <VoiceWaveformBars barClassName="bg-gradient-to-t from-blue-400 to-blue-400" />
                  </div>
                  ...
                  >
                    <div className="relative w-12 h-12 rounded-full bg-gradient-to-br from-blue-600 to-blue-700 shadow-[0_4px_20px_rgba(147,51,234,0.3)] flex items-center justify-center group-hover:scale-105 transition-transform duration-300 border border-white/20">
                ...
                >
                  <div className="flex flex-col-reverse items-end gap-1 mr-[-10px] relative z-20">
                    <div className="flex items-center gap-0.5 h-8 px-2 py-1.5 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-xl border border-blue-100 dark:border-blue-800 shadow-sm">
                      <VoiceWaveformBars barClassName="bg-gradient-to-t from-blue-500 to-blue-600 dark:from-blue-400 dark:to-blue-500" />
                    </div>
                    <motion.div
                  ...
                  <div
                    ...
                    onClick={handleToggleVoice}
                  >
                    <div className="relative w-16 h-16 rounded-full bg-gradient-to-br from-blue-600 to-blue-700 dark:from-blue-500 dark:to-blue-600 shadow-[0_4px_20px_rgba(147,51,234,0.3)] flex items-center justify-center z-20 group-hover:scale-105 transition-transform duration-300 border border-white/20 dark:border-white/10">
                    ...
                    <div className="absolute inset-0 rounded-full border border-blue-400 dark:border-blue-300 opacity-20 animate-[ping_3s_ease-in-out_infinite_0.5s] z-10" />
                    ...
                    <motion.button
                      ...
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'from-blue-400 to-blue-500 dark:from-blue-500 dark:to-blue-600 shadow-blue-400/30 dark:shadow-blue-600/20 hover:shadow-blue-400/40 dark:hover:shadow-blue-600/30',
                      )}
                    >
                      {asrEnabled ? (
